function [train_error, test_error] = cal_error_l2_reg_crossval(trainlabels, traindata, testlabels, testdata, lambda)
% This function does the following:
%   1. Augment data with a column vector of 1s.
...
% It returns training error and test error.
    ...
    trainlabels = permute(trainlabels, [2, 3, 1]);
    testlabels = permute(testlabels, [2, 3, 1]);
