function [train_error, test_error, w, b] = cal_error_linear_reg_6b(trainlabelspath, traindatapath, testlabelspath, testdatapath)
...
% It returns training error and test error.
    ...
    [w, b] = linearregression_6b(traindata_aug, trainlabels);
