...
cross_val_path_data = '\X_100%.txt';
cross_val_path_labels = '\y_100%.txt';
...
for i = 1:6
    [train_error(i), test_error(i)] = cal_error_linear_reg_6b_l2(trainlabels_100_path, traindata_100_path, testlabels_path, testdata_path, reg_param(i));
end
...
%Running the 10% dataset with lambda = 10
[train_error_final, test_error_final, w_final, b_final] = cal_error_linear_reg_6b_l2(trainlabels_100_path, traindata_100_path, testlabels_path, testdata_path, reg_param_min_cross_val);

fprintf('The weight vector is %f %f %f %f %f %f %f %f\n', w_final);

fprintf('The bias term is %f\n', b_final);

fprintf('The training error on the 10percent dataset with lambda = 10 is %f\n', train_error_final);

fprintf('The testing error with the 10percent dataset with lambda = 10 is %f\n', test_error_final);
